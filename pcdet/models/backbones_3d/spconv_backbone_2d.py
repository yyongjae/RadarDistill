...
class PillarRes18BackBone8x(nn.Module):
    ...
    def forward(self, batch_dict):
        ...
        x_conv3 = self.conv3(x_conv2)
        x_conv4 = self.conv4(x_conv3)
        # file_path = '/home/geonho/nuscenes/OpenPCDet_Final/distribution_lidar_1sweep.xlsx'
        # header_data = ['radar_voxels_num_8x']
        # iter_data = [x_conv4.indices.shape[0]]
        ...
        #     for i, header in enumerate(header_data, start=1):
        #         sheet.cell(row=1, column=i, value=header)
        #     for i, data in enumerate(iter_data, start=1):
        #         sheet.cell(row=2, column=i, value=data)
        #     wb.save(file_path)
        # else:
        ...
        #     for i, data in enumerate(iter_data, start=1):
        #         sheet.cell(row=next_row, column=i, value=data)
        #     wb.save(file_path)
        x_conv4 = x_conv4.dense()
        x_conv5 = self.conv5(x_conv4)
        # batch_dict.update({
