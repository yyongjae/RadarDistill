...
from .processor.point_feature_encoder import PointFeatureEncoder_Distill


class DatasetTemplate_Distill(torch_data.Dataset):
    def __init__(self, dataset_cfg=None, class_names=None, training=True, root_path=None, logger=None):
        ...
        self.point_feature_encoder = PointFeatureEncoder_Distill(
