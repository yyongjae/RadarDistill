...
from .augmentor.data_augmentor_multi_sweep_teacher import DataAugmentor_Multi_Sweep_Teacher
from .processor.data_processor_multi_sweep_teacher import DataProcessor_Multi_Sweep_Teacher
from .processor.point_feature_encoder_multi_sweep_teacher import PointFeatureEncoder_Distill_Multi_Sweep_Teacher


class DatasetTemplate_Distill_Multi_Sweep_Teacher(torch_data.Dataset):
    def __init__(self, dataset_cfg=None, class_names=None, training=True, root_path=None, logger=None):
        ...
        self.point_feature_encoder = PointFeatureEncoder_Distill_Multi_Sweep_Teacher(
            self.dataset_cfg.POINT_FEATURE_ENCODING,
            point_cloud_range=self.point_cloud_range
        )
        self.data_augmentor = DataAugmentor_Multi_Sweep_Teacher(
            self.root_path, self.dataset_cfg.DATA_AUGMENTOR, self.class_names, logger=self.logger
        ) if self.training else None
        self.data_processor = DataProcessor_Multi_Sweep_Teacher(
