...
class PointFeatureEncoder_Distill(object):
    ...
    def forward(self, data_dict):
        ...
        data_dict['use_lead_xyz'] = use_lead_xyz
        data_dict['radar_points'] = getattr(self, self.point_encoding_config.radar_encoding_type)(
    ...
    def radar_absolute_coordinates_encoding(self, points=None):
        if points is None:
            num_output_features = len(self.radar_used_feature_list)
            return num_output_features
