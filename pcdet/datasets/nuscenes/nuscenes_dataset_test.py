...
class NuScenesDataset_radar_test(DatasetTemplate):
    ...
    def crop_image(self, input_dict):
        ...
        for img in imgs:
            ...
            img_process_infos.append([resize, resize_dims,crop, False, 0])
    ...
    def __getitem__(self, index):
        ...
        points = self.get_radar_with_sweeps(index, max_sweeps=6)
